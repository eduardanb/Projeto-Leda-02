...
import Model.EstruturasDeDados.Algoritmos.HeapSort.HeapMedioCaso;
import Model.EstruturasDeDados.Algoritmos.HeapSort.HeapMelhorCaso;
import Model.EstruturasDeDados.Algoritmos.HeapSort.HeapPiorCaso;
import Model.EstruturasDeDados.Algoritmos.InsectionSort.InsectionMedioCaso;
import Model.EstruturasDeDados.Algoritmos.InsectionSort.InsectionMelhorCaso;
import Model.EstruturasDeDados.Algoritmos.InsectionSort.InsectionPiorCaso;
import Model.EstruturasDeDados.Algoritmos.MergeSort.*;
import Model.EstruturasDeDados.Algoritmos.QuickSort.QuickMedioCaso;
import Model.EstruturasDeDados.Algoritmos.QuickSort.QuickMelhorCaso;
import Model.EstruturasDeDados.Algoritmos.QuickSort.QuickPiorCaso;
import Model.EstruturasDeDados.Algoritmos.QuickSortMediana3.Quick3MedioCaso;
import Model.EstruturasDeDados.Algoritmos.QuickSortMediana3.Quick3MelhorCaso;
import Model.EstruturasDeDados.Algoritmos.QuickSortMediana3.Quick3PiorCaso;
import Model.EstruturasDeDados.Algoritmos.SelectionSort.SelectionMedioCaso;
import Model.EstruturasDeDados.Algoritmos.SelectionSort.SelectionMelhorCaso;
import Model.EstruturasDeDados.Algoritmos.SelectionSort.SelectionPiorCaso;
...
public class OrdenacaoPorMesCrescente {
    ...
    public static void Ordenacao(String[] args) {
        ...
        String SaidaCountingMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_countingSort_melhorCaso.csv";
        String SaidaCountingMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_countingSort_medioCaso.csv";
        String SaidaCountingPiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_countingSort_piorCaso.csv";
        String SaidaMergeMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_mergeSort_melhorCaso.csv";
        String SaidaMergeMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_mergeSort_medioCaso.csv";
        String SaidaMergePiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_mergeSort_piorCaso.csv";
        ...
        String SaidaQuickMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_quickSortmedianade3_melhorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaQuickMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_quickSortmedianade3_medioCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaQuickPiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_quickSortmedianade3_piorCaso.csv";
        try {
            long Inicio = System.nanoTime();
         ...
         String SaidaSelectionMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_selectionSort_melhorCaso.csv";
         try {
            long Inicio = System.nanoTime();
        ...
        String SaidaSelectionMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_selectionSort_medioCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaSelectionPiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_selectionSort_piorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaQuickSortMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_quickSort_melhorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaQuickSortMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_quickSort_medioCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaQuickSortPiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_quickSort_piorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaHeapSortMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_heapSort_melhorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaHeapSortMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_heapSort_medioCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        // Heap Sort - Pior Caso
        String SaidaHeapSortPiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_heapSort_piorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaInsectionSortMelhorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_insectionSort_melhorCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaInsectionSortMedioCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_insectionSort_medioCaso.csv";
        try {
            long Inicio = System.nanoTime();
        ...
        String SaidaInsectionSortPiorCaso = "Projeto-LEDA\\DadosFinais\\passwords_data_month_insectionSort_piorCaso.csv";
        try {
            long Inicio = System.nanoTime();
