...
public class OrdenacaoLengthDecrescente {
    ...
    public static void Ordenacao(String[] args) {
        ...
        String SaidaMedioCasoCounting = "Projeto-LEDA\\DadosFinais\\passwords_length_countingSort_medioCaso.csv";
        String SaidaPiorCasoCounting = "Projeto-LEDA\\DadosFinais\\passwords_length_countingSort_piorCaso.csv";
        String SaidaMelhorCasoCounting = "Projeto-LEDA\\DadosFinais\\passwords_length_countingSort_melhorCaso.csv";
        ...
        String SaidaMedioCasoMerge = "Projeto-LEDA\\DadosFinais\\passwords_length_mergeSort_medioCaso.csv";
        String SaidaPiorCasoMerge = "Projeto-LEDA\\DadosFinais\\passwords_length_mergeSort_piorCaso.csv";
        String SaidaMelhorCasoMerge = "Projeto-LEDA\\DadosFinais\\passwords_length_mergeSort_melhorCaso.csv";
        ...
        String SaidaMedioCasoQuickMedianaDe3 = "Projeto-LEDA\\DadosFinais\\passwords_length_quickSortMedianaDe3_medioCaso.csv";
        String SaidaPiorCasoQuickMedianaDe3 = "Projeto-LEDA\\DadosFinais\\passwords_length_quickSortMedianaDe3_piorCaso.csv";
        String SaidaMelhorCasoQuickMedianaDe3 = "Projeto-LEDA\\DadosFinais\\passwords_length_quickSortMedianaDe3_melhorCaso.csv";
        ...
        System.out.println("Iniciando ordenação por SelectionSort...");
         ///Selection Sort
         String SaidaMedioCasoSelection = "Projeto-LEDA\\DadosFinais\\passwords_length_selectionSort_medioCaso.csv";
         try {
        ...
        String SaidaPiorCasoSelection = "Projeto-LEDA\\DadosFinais\\passwords_length_selectionSort_piorCaso.csv";
        try {
            // Chamada para o método de ordenação Selection Sort
            long Inicio = System.nanoTime();
        ...
        String SaidaMelhorCasoSelection = "Projeto-LEDA\\DadosFinais\\passwords_length_selectionSort_melhorCaso.csv";
        try {
            // Chamada para o método de ordenação Selection Sort
            long Inicio = System.nanoTime();
        ...
        //quick sort
        String SaidaMedioCasoQuick = "Projeto-LEDA\\DadosFinais\\passwords_length_quickSort_medioCaso.csv";
        try {
        ...
        String SaidaPiorCasoQuick = "Projeto-LEDA\\DadosFinais\\passwords_length_quickSort_piorCaso.csv";
        try {
            // Chamada para o método de ordenação Quick Sort
            long Inicio = System.nanoTime();
        ...
        String SaidaMelhorCasoQuick = "Projeto-LEDA\\DadosFinais\\passwords_length_quickSort_melhorCaso.csv";
        try {
            // Chamada para o método de ordenação Quick Sort
            long Inicio = System.nanoTime();
        ...
        //Heap Sort
        String SaidaMedioCasoHeapSort = "Projeto-LEDA\\DadosFinais\\passwords_length_heapSort_medioCaso.csv";
        try {
        ...
        String SaidaPiorCasoHeapSort = "Projeto-LEDA\\DadosFinais\\passwords_length_heapSort_piorCaso.csv";
        try {
            // Chamada para o método de ordenação Heap Sort
            long Inicio = System.nanoTime();
        ...
        String SaidaMelhorCasoHeapSort = "Projeto-LEDA\\DadosFinais\\passwords_length_heapSort_melhorCaso.csv";
        try {
            // Chamada para o método de ordenação Heap Sort
            long Inicio = System.nanoTime();
        ...
        //Insection Sort
        String SaidaMedioCasoInsectionSort = "Projeto-LEDA\\DadosFinais\\passwords_length_insectionSort_medioCaso.csv";
        try {
        ...
        String SaidaPiorCasoInsectionSort = "Projeto-LEDA\\DadosFinais\\passwords_length_insectionSort_piorCaso.csv";
        try {
            // Chamada para o método de ordenação Insection Sort
            long Inicio = System.nanoTime();
        ...
        String SaidaMelhorCasoInsectionSort = "Projeto-LEDA\\DadosFinais\\passwords_length_insectionSort_melhorCaso.csv";
        try {
            // Chamada para o método de ordenação Insection Sort
            long Inicio = System.nanoTime();
